...
OMIKUJI_DATA = {
    "大吉": {
        ...
        "kotowaza": [
            ...
            ("継続は力なり", "日本のことわざ"),
            ("好きこそ物の上手なれ", "日本のことわざ"),
            ("今日という日は残りの人生の最初の日である", "日本の格言"),
            ("人生に遅すぎるということはない", "日本の格言"),
            ("天は自ら助くる者を助く", "サミュエル・スマイルズ（1904年没）"),
            ("志のある者は事ついに成る", "後漢書"),
            ("山高きがゆえに貴からず", "日本のことわざ"),
            ("為せば成る、為さねば成らぬ何事も", "上杉鷹山（1822年没）"),
            ("道は開ける", "日本の格言"),
            ("花は咲くことを知らず、ただ咲く", "日本の格言"),
            ("一期一会", "茶道の精神"),
            ("初心忘るべからず", "世阿弥（1443年頃没）"),
            ("知足者富", "老子"),
            ("己に克ちて礼に復る", "論語"),
            ("仁者は山を楽しみ、知者は水を楽しむ", "論語"),
            ("善く生きることは、善く戦うことである", "日本の格言"),
            ("人事を尽くして天命を待つ", "日本のことわざ"),
            ("桃栗三年柿八年", "日本のことわざ"),
            ("雨降って地固まる", "日本のことわざ"),
            ("塵も積もれば山となる", "日本のことわざ"),
            ("石の上にも三年", "日本のことわざ"),
