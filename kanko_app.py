...
SPOT_DATA_BUILTIN = [
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Takamikura_yama.jpg/320px-Takamikura_yama.jpg",
    ...
    },
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Mt_Kasagata_from_Mt_Aoshima.jpg/320px-Mt_Kasagata_from_Mt_Aoshima.jpg",
        "photo_credit": "© Wikimedia Commons",
    ...
    },
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5f/Himeji_Castle_The_Keep_Towers.jpg/320px-Himeji_Castle_The_Keep_Towers.jpg",
        "photo_credit": "© 663highland / Wikimedia Commons CC BY-SA",
    ...
    },
    {
        ...
        "prefecture": "兵庫県", "city": "加古川市",
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Kakurinji07s3200.jpg/320px-Kakurinji07s3200.jpg",
        "photo_credit": "© 663highland / Wikimedia Commons CC BY-SA",
    ...
    # ★ 関西エリア
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Todaiji_daibutsuden.jpg/320px-Todaiji_daibutsuden.jpg",
        "photo_credit": "© Wikimedia Commons CC BY-SA",
    ...
    },
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Kinkaku-ji_the_Golden_Pavilion_in_Kyoto_overlooking_the_lake_-_high_rez.jpg/320px-Kinkaku-ji_the_Golden_Pavilion_in_Kyoto_overlooking_the_lake_-_high_rez.jpg",
        "photo_credit": "© Wikimedia Commons CC BY-SA",
    ...
    },
    {
        ...
        "photo_url": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Osaka_Castle_keep.jpg/320px-Osaka_Castle_keep.jpg",
        "photo_credit": "© Wikimedia Commons CC BY-SA",
...
.ar-card-photo-credit{font-size:10px;color:rgba(255,255,255,0.65);text-align:right;margin-bottom:6px;}
...
def render_spot_card(spot, mode_cfg, dist_km, brg, expanded, lang="ja"):
    ...
    if photo_url and not is_osm:
        photo_html=(
            f'<img src="{photo_url}" class="ar-card-photo" alt="{spot["name"]}" '
            f'onerror="this.style.display=\'none\'">'
            f'<div class="ar-card-photo-credit">{photo_credit}</div>'
        )
...
.info-panel,.ar-compass,.lookaround-card,.map-placeholder,.share-card,.report-form{background:rgba(20,20,60,0.65)!important;color:#CCCCFF!important;border-color:rgba(80,80,160,0.40)!important;}
    ...
    st.markdown(
        ...
        f'写真: Wikimedia Commons CC BY-SA ／ 地図タイル：国土地理院 ／ © OpenStreetMap contributors<br>'
